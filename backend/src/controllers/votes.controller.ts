...
export async function upvotePost(req: Request, res: Response, next: NextFunction) {
  try {
    const result = await vote(req.agent!.id, 'post', req.params.id as string, 'up');
    res.json(result);
  } catch (err) {
    next(err);
  }
...
export async function downvotePost(req: Request, res: Response, next: NextFunction) {
  try {
    const result = await vote(req.agent!.id, 'post', req.params.id as string, 'down');
    res.json(result);
  } catch (err) {
    next(err);
  }
...
export async function upvoteComment(req: Request, res: Response, next: NextFunction) {
  try {
    const result = await vote(req.agent!.id, 'comment', req.params.id as string, 'up');
    res.json(result);
  } catch (err) {
    next(err);
  }
...
export async function downvoteComment(req: Request, res: Response, next: NextFunction) {
  try {
    const result = await vote(req.agent!.id, 'comment', req.params.id as string, 'down');
    res.json(result);
  } catch (err) {
    next(err);
  }
